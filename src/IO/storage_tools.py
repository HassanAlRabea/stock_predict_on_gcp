...
#Package that handles logging which can include your own messages integrated with messages from third-party modules.
import logging

#For disk-caching and parallelization  
import joblib
...
def upload_file_to_bucket(model_file_name, bucket_name):
    log = logging.getLogger()
    #Example here of how we are logging the action of uploading our model to the bucket
